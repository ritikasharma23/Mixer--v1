      ...
      <div className={style.wrapper}>
        <div className={style.container}>
          <div className={style.contentWrapper}>
                  ...
                  <>
                    <div className={style.details}>
                      ...
                      <span className="flex flex-wrap items-center justify-center space-x-5">
                        <span className="mt-4 mb-3 justify-center text-center font-semibold font-sans text-base not-italic leading-5 text-[#111111]">
                          Start Mixing
                        </span>
                      </span>
                    </div>
            ...
            <div className={style.glowDivBox}>
              <div className="relative h-[full] w-[95%] justify-center rounded-lg bg-lime-100	 px-7 py-9  text-center leading-none lg:w-full ml-5">
                <>
                  <div className={style.details}>
                    <span className="flex flex-wrap justify-center space-x-5">
                      <span className="pr-6 text-xl font-bold text-black lg:text-3xl">
                    ...
                    <span className="flex flex-wrap items-center justify-center space-x-5">
                      <span className="mt-4 mb-3 justify-center font-semibold text-center font-sans text-base not-italic leading-5 text-[#111111]">
